...
namespace WeiXin.Helpers.Containers
{
    /// <summary>
    /// 容器帮助类
    /// </summary>
    ...
    {
        /// <summary>
        /// 获取缓存Key（命名空间，形如：Container:My.Weixin.MP.Containers.AccessTokenBag）
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// 获取ContainerBag缓存Key，包含命名空间（形如：Container:My.Weixin.MP.Containers.AccessTokenBag:wx669ef95216eef885）
        /// </summary>
